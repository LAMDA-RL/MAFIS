...
def parse_args():
    ...
    parser.add_argument(
        "--filter_by_envs",
        nargs="+",
        default=["miner_easy_2_vs_2", "miner_medium_2_vs_2", "miner_hard_2_vs_2", "pz-mpe-simple-spread-v3", "pz-mpe-simple-speaker-listener-v4", "pz-mpe-simple-reference-v3", "protoss_5_vs_5", "protoss_10_vs_11", "zerg_5_vs_5", "zerg_10_vs_11", "terran_5_vs_5", "terran_10_vs_11"],
